...
import cn.gdrfgdrf.cuteframework.api.exception.PluginNameConflictException;
...
public class PluginManager {
     ...
     * @return cn.gdrfgdrf.cuteframework.api.PluginManager
     ...
     * @param name
	 *        插件名
     * @return cn.gdrfgdrf.cuteframework.api.common.PluginState
     *         插件状态
     * @throws AssertNotNullException
     *         当 name 为 null 时抛出
     * @Author gdrfgdrf
    ...
    /**
     * @Description 获取所有插件
     * @return java.util.Map<java.lang.String,cn.gdrfgdrf.cuteframework.api.base.Plugin>
     *         插件映射表
     * @Author gdrfgdrf
     * @Date 2024/5/5
     */
     ...
     * @return java.util.Map<cn.gdrfgdrf.cuteframework.api.base.Plugin,cn.gdrfgdrf.cuteframework.api.common.PluginState>
     *         插件状态映射表
     * @Author gdrfgdrf
     * @Date 2024/5/5
     */

...
import cn.gdrfgdrf.cuteframework.api.exception.*;
...
public class PluginLoader {
     ...
     * 该构造函数仅允许 cn.gdrfgdrf.cuteframework.api.loader.PluginLoader 的 getInstance 方法调用
     *
    ...
    private PluginLoader() throws AssertNotNullException, StackIllegalOperationException, StackIllegalArgumentException {
        StackUtils.onlyMethod("cn.gdrfgdrf.cuteframework.api.loader.PluginLoader", "getInstance");
    }

    /**
     * @Description 单例模式，获取 {@link PluginLoader} 实例，
     * 该方法仅允许 cn.gdrfgdrf.cuteframework.CuteFramework 的 run 方法
     *
     * @return cn.gdrfgdrf.cuteframework.api.loader.PluginLoader
     ...
     * 该错误不会直接抛出，而且会发布一个 {@link cn.gdrfgdrf.cuteframework.api.event.PluginEvent.LoadError} 事件，
     * 该事件将会异步发出
     *
     * @throws cn.gdrfgdrf.cuteframework.utils.stack.exception.StackIllegalOperationException
     *         当不被允许的类或方法调用该方法时抛出
	 ...
	 *        插件描述文件
     * @return cn.gdrfgdrf.cuteframework.api.base.Plugin
     *         正常加载的插件主类
     ...
     * @param pluginFile
	 *        插件文件
     * @return cn.gdrfgdrf.cuteframework.api.common.PluginDescription
     *         插件描述文件在代码中的表示
     * @throws IOException

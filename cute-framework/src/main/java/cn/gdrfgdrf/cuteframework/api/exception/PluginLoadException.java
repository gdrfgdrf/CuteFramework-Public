...
/**
 * @Description 插件加载错误，当 {@link cn.gdrfgdrf.cuteframework.api.loader.PluginLoader} 加载插件错误时将抛出此类，
 * 错误实例将会包含在该类中并以 {@link cn.gdrfgdrf.cuteframework.api.event.PluginEvent.LoadError} 的形式发布
 *
 * @Author gdrfgdrf
 * @Date 2024/5/5
 */

...
package cn.gdrfgdrf.cuteframework.api.common;
...
/**
 * @Description 插件状态，
 * 若插件的状态变化顺序异常则抛出 {@link cn.gdrfgdrf.cuteframework.api.exception.PluginIllegalStateChangeException}
 *
 * @Author gdrfgdrf
 * @Date 2024/5/5
 */
public enum PluginState {
     ...
     * 即插件被 {@link cn.gdrfgdrf.cuteframework.api.loader.PluginLoader} 加载完成后的状态，
     * 对于一个插件，该状态只能存在一次，

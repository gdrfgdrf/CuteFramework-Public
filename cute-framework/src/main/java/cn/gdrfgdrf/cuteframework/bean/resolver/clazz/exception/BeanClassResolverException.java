...
package cn.gdrfgdrf.cuteframework.bean.resolver.clazz.exception;
...
/**
 * @Description 当 {@link cn.gdrfgdrf.cuteframework.bean.resolver.clazz.base.BeanClassResolver} 发生错误时
 * {@link cn.gdrfgdrf.cuteframework.bean.resolver.clazz.base.BeanClassResolver} 将会把异常实例包装到该类并抛出
 *
 * @Author gdrfgdrf
 * @Date 2024/5/4
 */

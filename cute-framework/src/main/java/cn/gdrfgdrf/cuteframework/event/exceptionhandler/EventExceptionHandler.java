...
import cn.gdrfgdrf.cuteframework.exceptionhandler.ExceptionDispatcher;
...
/**
 * @Description 事件处理时出现错误会被该类捕获并提供给 {@link cn.gdrfgdrf.cuteframework.exceptionhandler.ExceptionDispatcher} 进行分发
 * @Author gdrfgdrf
 * @Date 2024/4/24
 */
@Slf4j
public class EventExceptionHandler implements SubscriberExceptionHandler {
     ...
     * @return cn.gdrfgdrf.cuteframework.event.exceptionhandler.EventExceptionHandler

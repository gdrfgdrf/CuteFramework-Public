 ...
 * ===================================================================================================================== <p>
 * 以下为语言加载规则 <p>
 * 语言的加载将会由 {@link cn.gdrfgdrf.core.locale.LanguageLoader} 完成。<p>
 * 所有语言汇总类必须实现 {@link cn.gdrfgdrf.core.locale.base.LanguageCollect}，<p>
 * 所有语言翻译类必须实现 {@link cn.gdrfgdrf.core.locale.base.LanguageBlock}，<p>
 * <p>
 * 程序会先从配置文件中获取到设置的语言，<p>
 * 之后检查该语言文件是否存在，不存在则从语言实现类中读取语言并写入文件，存在则从文件中读取语言，<p>
 * 读取到语言之后将会通过反射赋值到汇总类。<p>
 * 所有实现了 {@link cn.gdrfgdrf.core.locale.base.LanguageBlock} 的类的所有字段 <p>
 * 的类型都必须是 {@link cn.gdrfgdrf.core.locale.LanguageString}，<p>
 * 并且字段名必须存在于汇总类中。<p>
 * 以下为语言文件的格式 <p>
 *      语言汇总类名: { <p>
 *          "键1": "值1", <p>
 ...
 *                  之后反射设置给字段，<p>
 *                  若 {@link cn.gdrfgdrf.core.locale.base.LanguageCollect} 的 "SystemLanguage" 类中 <p>
 *                  有值是 语言汇总类名 "SystemLanguage" 节点下没有的，<p>
 *                  则会从当前语言下对应 {@link cn.gdrfgdrf.core.locale.base.LanguageBlock} 的 "SystemLanguage" 类中获取。<p>
 *                  若找不到则直接设置为 null，<p>
 *                  如此往复，语言文件读取完成。<p>
 *          文件不存在，<p>
 ...
 *                  并前往 {@link cn.gdrfgdrf.core.locale.base.LanguageBlock} 的 "SystemLanguage" 类 获取到 <p>
 *                  拥有相同名字的字段，并获取该字段的内容，<p>
 *                  然后赋值给 {@link cn.gdrfgdrf.core.locale.base.LanguageCollect} 的 "SystemLanguage" 类 的对应字段，<p>
 *                  如此往复，类文件读取完成，<p>
 *                  完成读取后将会把所有 {@link cn.gdrfgdrf.core.locale.base.LanguageCollect} 的类序列化到语言文件。<p>
 *
 * @Author gdrfgdrf
 * @Date 2024/4/9
 */
